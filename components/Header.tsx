    ...
    >
      <div className="w-full max-w-6xl mx-auto flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
                  ...
                  {count === 0 ? (
                    <div className="px-5 py-8 text-center">
                      ...
                      <Link
                        href="/tarifs"
                        onClick={closeCart}
                        className="mt-4 inline-block text-[#30938d] text-sm font-semibold hover:underline"
                      >
                        Voir les tarifs →
                      </Link>
                    </div>
                        ...
                        <div className="flex items-start gap-3 p-3 rounded-xl bg-gray-50">
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <div className="flex items-center gap-2 mt-2">
                              <button
                                onClick={remove}
                                className="w-6 h-6 rounded-full border border-gray-200 bg-white flex items-center justify-center text-gray-500 hover:border-gray-400 transition-colors"
          ...
          <Link
            href="/tarifs"
            className="text-sm font-semibold px-4 py-1.5 rounded-full text-[#0d3332] bg-white hover:bg-white/90 transition-colors"
          >
            Commander
          </Link>
        </div>
